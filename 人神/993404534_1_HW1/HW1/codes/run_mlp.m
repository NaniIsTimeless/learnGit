...
solver.batch_size = 32;     % minibatch sample size 
solver.display_freq = 100;  % the number of iterations between displaying info. 
solver.max_iter = 10000;    % the maximum number of iterations
solver.test_freq = 5000;    % The number of iterations between testing.
